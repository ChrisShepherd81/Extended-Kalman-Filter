...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
EkfFileHandler::EkfFileHandler(string in_file_name, string out_file_name) :
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool EkfFileHandler::check_files() {
  if (!in_file.is_open()) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void EkfFileHandler::read_file(vector<MeasurementPackage> &measurement_pack_list,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void EkfFileHandler::write_to_file(const VectorXd& v, size_t valToWrite)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void EkfFileHandler::write_to_file(double val)
{
  out_file << val << "\t";
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void EkfFileHandler::write_to_file(string val)
{
  out_file << val;
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
